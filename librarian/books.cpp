...
void books::readSetting(){
    ...
    if (file.open(QIODevice::ReadOnly)){
        ...
        ui.checkBox_isbn->setChecked(node.attributes().namedItem("isbn").nodeValue().toInt());
        ui.checkBox_title->setChecked(node.attributes().namedItem("title").nodeValue().toInt());
        ui.checkBox_sect->setChecked(node.attributes().namedItem("sect").nodeValue().toInt());
        ui.checkBox_cat->setChecked(node.attributes().namedItem("cat").nodeValue().toInt());
        ui.checkBox_pub->setChecked(node.attributes().namedItem("pub").nodeValue().toInt());
        ui.checkBox_year->setChecked(node.attributes().namedItem("year").nodeValue().toInt());
        ui.checkBox_place->setChecked(node.attributes().namedItem("place").nodeValue().toInt());
        ui.checkBox_in->setChecked(node.attributes().namedItem("in").nodeValue().toInt());
        ui.checkBox_out->setChecked(node.attributes().namedItem("out").nodeValue().toInt());
        ui.checkBox_read->setChecked(node.attributes().namedItem("read").nodeValue().toInt());
        ui.checkBox_dost->setChecked(node.attributes().namedItem("dost").nodeValue().toInt());
        ui.checkBox_auth->setChecked(node.attributes().namedItem("auth").nodeValue().toInt());
...
void books::writeSetting(){
    ...
    node.attributes().namedItem("y").setNodeValue(QString("%1")
                                                      .arg(geometry().y()));
    node.attributes().namedItem("isbn").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_isbn->isChecked()));
    node.attributes().namedItem("title").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_title->isChecked()));
    node.attributes().namedItem("sect").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_sect->isChecked()));
    node.attributes().namedItem("cat").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_cat->isChecked()));
    node.attributes().namedItem("pub").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_pub->isChecked()));
    node.attributes().namedItem("year").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_year->isChecked()));
    node.attributes().namedItem("place").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_place->isChecked()));
    node.attributes().namedItem("in").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_in->isChecked()));
    node.attributes().namedItem("out").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_out->isChecked()));
    node.attributes().namedItem("read").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_read->isChecked()));
    node.attributes().namedItem("dost").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_dost->isChecked()));
    node.attributes().namedItem("auth").setNodeValue(QString("%1")
                                                     .arg(ui.checkBox_auth->isChecked()));
